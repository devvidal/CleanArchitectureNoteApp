...
class AddEditNoteViewModel @Inject constructor(
    ...
    fun onEvent(event: AddEditNoteEvent) {
        when(event) {
            ...
            is AddEditNoteEvent.SaveNote -> handleSaveNote()
        }
    }

    private fun handleFetchNote(noteId: Int) = viewModelScope.launch {
        noteUseCases.fetchNoteUseCase(noteId)?.also { note ->
    ...
    private fun handleSaveNote() = viewModelScope.launch {
