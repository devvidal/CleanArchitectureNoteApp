...
import com.plcoding.cleanarchitecturenoteapp.feature_note.domain.use_case.FetchNoteUseCase
import com.plcoding.cleanarchitecturenoteapp.feature_note.domain.use_case.FetchNotesUseCase
...
object AppModule {
    ...
    fun provideNoteUseCases(repository: NoteRepository): NoteUseCases {
        return NoteUseCases(
            fetchNotesUseCase = FetchNotesUseCase(repository),
            deleteNoteUseCase = DeleteNoteUseCase(repository),
            addNoteUseCase = AddNoteUseCase(repository),
            fetchNoteUseCase = FetchNoteUseCase(repository)
        )
    }
}